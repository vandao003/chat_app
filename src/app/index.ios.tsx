...
import { Image, Keyboard, KeyboardAvoidingView, ScrollView, StatusBar, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native'
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#000' }}>
            ...
            >
                <ScrollView
                    ...
                    bounces={true}  // iOS native bounce effect
                >
                    <TouchableOpacity
                        activeOpacity={1}
                    ...
                    >
                        <View className='flex-1 items-center justify-center px-6 py-8'>
                            ...
                            <View className='items-center mb-10'>
                                ...
                                />
                                <Text className='text-white text-3xl font-bold'>Welcome iOS</Text>
...
const styles = StyleSheet.create({
    input: {
        ...
        paddingVertical: 16,  // iOS optimized padding
        borderRadius: 12,
        borderWidth: 1,
        borderColor: '#374151',
        fontSize: 16,
